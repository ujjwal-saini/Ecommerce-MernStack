...
function UserOrders() {
    ...
    return (
        <div
            className={`container-fluid container-md mt-3 mb-5 px-2 px-md-3 
                ...
                orders.map((order) => {
                    ...
                    return (
                        ...
                        <div
                            ...
                            {/* Header */}
                            <div
                                className={`card-header d-flex flex-column flex-md-row justify-content-between align-items-md-center
                                ${isDark
                            ...
                            <div className="card-body">
                                ...
                                {order.items.map((item, index) => (
                                    ...
                                    <div
                                        key={index}
                                        className={`d-flex flex-column flex-md-row align-items-center pb-3 mb-3
                                        ${isDark
